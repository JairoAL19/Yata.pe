    ...
    <div class="main-panel" >
        ...
        <div class="content" id="bg" >
            ...
            <div class="CATEGORIAS1" style="margin-top: 2%">
                @foreach($ipods as $ipod)
                <div id="cel" style="display: inline-block; "> 
                    <div style="margin-top: 0%">
                    <a href="/Reciclar/P/{{ $ipod->cod_produc }}/{{ $ipod->memoria }}">
                    <img style="width: 100%; " src="../../{{ $ipod->foto }}">
                    <label style="font-size: 100%; margin-top: 8%; text-align: center; width: 100%">{{$ipod->nombre}}</label>
                    <label style="font-size: 80%; margin-top: 2%; text-align: center; width: 100%; color: green">S/. {{$ipod->precio_ini}}</label>
                    </a>
                    </div>
                </div>
                @endforeach
