        ...
        <div class="content" id="bg" >
            ...
            <div class="CATEGORIAS1" style="margin-top: 2%">
                <div id="cel" style="display: inline-block; "> 
                    ...
                    <a href="/Reciclar/iPod_Nano/P">
                    <img style="width: 100%; " src="../../img/ipads/nano.png">
                    <label style="font-size: 20px; margin-top: 8%; text-align: center; width: 100%">iPod Nano</label>
                    </a>
                    </div>
                </div>
                ...
                <div id="cel" style="display: inline-block; "> 
                    <div style="margin-top: 0%">
                    <a href="/Reciclar/iPod_Touch/P">
                    <img style="width: 100%; " src="../../img/ipads/touch.png">
                    <label style="font-size: 20px; margin-top: 8%; text-align: center; width: 100%">iPod Touch</label>
                    </a>
                    </div>
                </div>
        </div>
